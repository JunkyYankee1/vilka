...
export default function CheckoutModal({ isOpen, onClose, baseItems }: CheckoutModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 py-4 md:rounded-t-3xl md:px-6">
          <h2 className="text-lg font-semibold text-slate-900">Оформление заказа</h2>
          <button
            type="button"
            onClick={onClose}
